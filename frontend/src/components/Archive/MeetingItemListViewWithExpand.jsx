...
function MeetingItemListView({ state = MeetingItemStates.IN_PROGRESS }) {
    ...
    switch (state) {
      case MeetingItemStates.COMPLETED: {
        return [
          'completed',
          <i
            className={classnames(commonClassName, 'fas', 'fa-check', 'fa-sm')}
          />,
        ]
      }
      ...
      default: {
        return [
          'pending',
          <i
            className={classnames(commonClassName, 'fas', 'fa-circle', 'fa-lg')}
          />,
        ]
      }
    }
  ...
  return (
    <div
      className={classnames('meeting-item-list-view', stateClassName, {
    ...
    >
      <div className="row">
        ...
        <div className="details">
          <div className="title">
            2.1 Approval of Unemployment Insurance Appropriation Ordinance
            Adjustments to Increase Payment of Claims and Access to Reserves
          </div>
