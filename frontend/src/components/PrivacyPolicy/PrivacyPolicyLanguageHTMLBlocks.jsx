...
export const privacyPolicyLanguages = (language = "en") => {
  const allLanguages = {
    en: (
      <>
        ...
        <ul>
          <li>
            ...
            and/or Phone number (optional), through signing up for an account
            with City of San Jose to receive notifications on meeting updates.
          </li>
          <li>
            We do not give, share, sell, rent or transfer any personal
        ...
        <p>
          ...
          control over that other website. Therefore, we cannot be responsible
        ...
        <p>
          ...
          under the age of 13 may provide any personal information to, or on,
          the Website. We do not knowingly collect personal information from
          ...
          features that may be available on this Website, or provide any
          information about yourself to us, including your name, telephone
          number, or e-mail address you may use.
        </p>
        <p>
        ...
        <p>
          ...
          your profile through the website and visiting your account profile
          page or settings page.
        </p>
        <h2>Changes to our privacy policy</h2>
        <p>
          If we decide to change our privacy policy, we will post those changes
          on this page. Questions? Email us at <span className="email-text">sharedadmin@codeforsanjose.org</span>.
        </p>
      </>
    ),
    es: <></>,
