...
function MeetingItem({
  ...
  const [stateClassName, icon, statusString] = useMeetingItemIcon(
    meetingItemState,
  )
  ...
  return (
    <div className={classnames('meeting-item-view', stateClassName)}>
      ...
      <p className={'recommendation'}>
        ...
        tempor incididunt ut labore et dolore magna aliqua. Viverra maecenas
        accumsan lacus vel facilisis volutpat est velit. In dictum non
        consectetur a erat. Phasellus faucibus scelerisque eleifend donec
