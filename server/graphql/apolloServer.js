  ...
  const resolvers = {
    ...
    Mutation: {
      ...
      createSubscription: async (_parent, args) =>
        mutationResolver.createSubscription(args),
    },
  }
